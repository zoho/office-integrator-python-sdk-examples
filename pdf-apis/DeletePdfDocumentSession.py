...
class DeletePdfDocumentSession:
    ...
    # Refer API documentation - https://www.zoho.com/officeintegrator/api/v1/zoho-pdfeditor-delete-session.html
    @staticmethod
    def execute():
        DeletePdfDocumentSession.init_sdk()
        ...
        if response is not None:
            ...
            if responseObject is not None:
                if isinstance(responseObject, CreateDocumentResponse):
                    ...
                    if deleteApiResponse is not None:
                        ...
                        if deleteResponseObject is not None:
                            if isinstance(deleteResponseObject, DocumentSessionDeleteSuccessResponse):
                                print('PDF Document Session delete status : ' + str(deleteResponseObject.get_session_deleted()))
                                ...
                                print('Delete PDF Document Session Request Failed')
                    ...
                    print('PDF Document Session Creation Request Failed')
